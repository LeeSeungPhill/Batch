...
import kis_api_prod_phills15 as ka_phills15
import datetime
...
if result_one == None:
    ka_phills15.auth()
    a = ka_phills15.getTREnv()

    try:
        # DB 연결된 커서 설정
        cur1 = conn.cursor()        
        d = ka_phills15.get_acct_balance('True');  # 계좌 잔고 조회
        ...
        cur2 = conn.cursor()
        e = ka_phills15.get_acct_balance();  # 계좌 잔고 조회
        ...
        for i, name in enumerate(e.index):
            ...
            f = ka_phills15.get_current_price(e_code)
        ...
        for i in result:
            ...
            if len(i[0]) == 4:
                b = ka_phills15.inquire_daily_indexchartprice(i[0], today)
                ...
                f = ka_phills15.get_current_price(code)
        ...
        cur3 = conn.cursor()
        g = ka_phills15.get_my_complete(today)  # 일별 주문 체결 조회
