...
get_handler_short_mng = CommandHandler('short', get_command_short_mng)
updater.dispatcher.add_handler(get_handler_short_mng)
updater.dispatcher.add_handler(MessageHandler(Filters.text & ~Filters.command, short_trading_mng))
