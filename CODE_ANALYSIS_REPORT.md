...
**합계: 14개 파일에서 21건의 깨진 import. 이 파일들은 실행 시 즉시 `ModuleNotFoundError`로 종료됨.**
...
| 12 | 트랜잭션 rollback 추가 (commit:rollback = 184:7) | HIGH |

### Phase 3: 코드 품질 (중기)

| # | 항목 | 효과 |
|---|------|------|
| 13 | auth()/account() 공통 모듈화 (12개 파일) | ~285줄 절감 |
| 14 | DB 연결 패턴 공통화 (16개 파일) | ~80줄 절감 + 보안 |
